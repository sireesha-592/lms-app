...
const fs   = require('fs');
const FRONTEND_URL = 'https://code-medha-frontend-sireeshas-projects-fba69901.vercel.app/#/admin/login';
let mainWindow = null;
let tray = null;
...
function createMainWindow() {
  mainWindow = new BrowserWindow({ width: 1366, height: 768, minWidth: 1024, minHeight: 600, title: 'CodeMedha Admin Panel', icon: path.join(__dirname, 'icons', 'icon.png'), show: false, webPreferences: { nodeIntegration: false, contextIsolation: true, webSecurity: true } });
...
function createTray() {
  ...
  tray.setToolTip('CodeMedha Admin Panel');
